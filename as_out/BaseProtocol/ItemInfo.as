package BaseProtocol {
	...
	public dynamic final class ItemInfo extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const ID:FieldDescriptor_TYPE_UINT32 = new FieldDescriptor_TYPE_UINT32("BaseProtocol.ItemInfo.id", "id", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const COUNT:FieldDescriptor_TYPE_UINT32 = new FieldDescriptor_TYPE_UINT32("BaseProtocol.ItemInfo.count", "count", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 2:
					if (count$count != 0) {
						throw new flash.errors.IOError('Bad data format: ItemInfo.count cannot be set twice.');
					}
					++count$count;
